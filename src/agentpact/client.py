...
class AgentPactClient:
    ...
    def agents_verification(self, id: str, params: dict | None = None):
        return self._request("GET", f"/api/agents/{id}/verification", params=params)
    ...
    def admin_force_refund(self, data: dict | None = None):
        return self._request("POST", f"/api/admin/force-refund", json=data)
